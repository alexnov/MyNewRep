...
public class Geometry {
	...
	public static double round_lenght(double z1, double z2, double h1, double h2) {
		double l = (Math.abs(z1 - z2) * (h2 - h1))
				/ (Math.abs(Math.sin(z1 * 3.14 / 180)
						- Math.sin(z2 * 3.14 / 180)) * 57.296);
		return l;
	}
	...
	public static double round_height(double z1, double z2, double l1, double l2) {
		double h = (57.296 * (l2 - l1) * Math.abs(Math.sin(z1 * 3.14 / 180)
				- Math.sin(z2 * 3.14 / 180)))
				/ Math.abs(z2 - z1);
		return h;
	}
	...
	// Метод для расчета длины по стволу в таблице, если изменяется зенитный
	// угол
	...
	// Метод для нахождения последнего значимого элемента массива предыдущей
	// колонны
	...
	// Метод для нахождения последнего значимого элемента массива открытого
	// ствола
	...
	// Метод для нахождения последнего значимого элемента массива цементируемой
	// колонны
	...
	// Метод для нахождения интервала, в котором находится заданная глубина по
	// вертикали
